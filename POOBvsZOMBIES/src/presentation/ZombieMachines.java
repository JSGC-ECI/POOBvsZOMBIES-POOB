...
public class ZombieMachines extends JFrame {
    ...
    /**
     * Constructor for objects of class ZombieMachine
     */
    ...
    public void prepareElementsBoard() {
        ...
        JButton button1 = new JButton("ZombiesOriginal", new ImageIcon(""));
        buttonPanel.add(button1);
        JButton button2 = new JButton("ZombiesStrategic",new ImageIcon(""));
